	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
			<div class="privacy about">
				<span></span><h3>Pay<span>ment</span></h3>
				<!--/tabs-->
				<div class="responsive_tabs">
					...
					<script src="https://www.paypal.com/sdk/js?client-id=AeXXiQtjxenMuYGmd9eVQGfUgonJJ4czWf3G4ktxerEeCT79WImgLRfPqwyBOiWCDWk7A8kwzdFoh3I8&currency=EUR" data-sdk-integration-source="button-factory"></script>
					<script>
					function initPayPalButton() {
						...
						createOrder: function(data, actions) {
							...
							purchase_units: [{"description":"Bestelling op naam van <NAAM>","amount":{"currency_code":"EUR","value":211.00}}]
							});
						},
