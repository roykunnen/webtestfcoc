	...
	<div class="banner_top" id="home">
		<div class="wrapper_top_w3layouts">
			...
			<div class="header_agileits">
				<div class="logo">
					<h1><a class="navbar-brand" href="index.php"><span>Brontona</span> <i>Shoes</i></a></h1><br><br>
					<p style= "color:white">Free shipping. 30 day return policy!</p>
				</div>
				...
				<div>
					<a href="logout.php"><button class="top_logout top_nav_right" type="submit" name="submit" value="" ><img id = "img1" src= "images/logouticon.png" width = "25px" height = "22px"></button></a>
				</div>
				<!-- Login profile -->
				<div>
